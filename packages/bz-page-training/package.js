...
Package.onUse(function(api) {
  ...
  api.use(['arutune:bz-main', 'arutune:bz-page-search']);
  ...
  api.addFiles([
    ...
    'client/browser/page-trainings.html',
    'client/browser/page-trainings.js',
    'client/browser/page-trainings.less'
