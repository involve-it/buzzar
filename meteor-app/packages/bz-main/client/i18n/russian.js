...
ru = {
  ...
  HEADER: {
    ...
    'PARAG_2': 'Но Светлячки здесь не просто ради праздного любопытства, а служат конкретной цели - живые объявления вокруг. Ты устанавливаешь Светлячка и твое объявление получает новый источник просмотров - людьми, находящимися поблизости! Представь себе виртуальную визитку, только носишь ты ее не в кошельке, а в мобильном телефоне, и видят ее не избранные, а все те, кто рядом! Нас также видно в гугле и соцсетях, и поэтому твое объявление превращается в собственную интернет-страницу, которую при желании увидит весь интернет.',
    'PARAG_3': 'Светлячки - свет, мы работаем со светом, ищем свет и несём свет. Светлячков много и мы вокруг, и даже если пока кто-то не светит, - это, на самом деле, вопрос времени!',
