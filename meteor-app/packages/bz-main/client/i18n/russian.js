...
ru = {
  ...
  HEADER: {
    ...
    'PARAG_1': 'Светлячки позволяют привязать объявление или любой адрес в интернете к текущему местоположению пользователя, и, как результат, осуществлять веб поиск информации среди людей вокруг.Таким образом, наша система позволяет искать, информацию здесь и сейчас, с возможностью мгновенной встречи с ее владельцем. Ненужное промежуточное звено (поиск по интернету, договор о встрече, дорогу к месту) можно исключить, если потенциально интересующий нас человек (товар, услуга) находится поблизости.',
    'PARAG_2': 'Мы как бы расширяем возможности Веба, посредством привязки информации к реальным людям и координатам, что дает веб-ресурсам новое,- пространство-временное, качество и следовательно - путь напрямик к цели!',
    'PARAG_3': 'Представь себе виртуальную визитку, только носишь ты ее не в кошельке, а в мобильном телефоне, и видят ее не избранные, а все те, кто рядом! Нас также видно в Google и соцсетях, и поэтому твое объявление превращается в собственную интернет-страницу, которую при желании увидит весь интернет.',
