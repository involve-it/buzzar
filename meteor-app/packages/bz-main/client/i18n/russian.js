...
ru = {
  ...
  /*PAGE ABOUT US*/
  HEADER: {
    // 'PARAG_1': 'Тьма - отсутствие света. Знание - это свет. Знание о том, кто вокруг нас, на каких они языках говорят, чем живут, что предлагают и во что верят. А мы верим, что такое знание сделает мир вокруг светлее, потому что понятнее.',
    'PARAG_1': 'Представь себе виртуальную визитку, только носишь ты ее не в кошельке, а в мобильном телефоне, и видят ее не избранные, а все те, кто рядом! Нас также видно в Google и соцсетях, и поэтому твое объявление превращается в собственную интернет-страницу, которую при желании увидит весь интернет.',
    'PARAG_2': '*** все что дальше должно быть выделено, как менее занчимый текст*** Мы расширяем возможности Веба, посредством привязки информации к реальным людям и координатам, что дает веб-ресурсам новое,- пространство-временное, качество, то есть путь напрямик к цели!',
    'PARAG_3': 'Светлячки позволяют привязать объявление или любой адрес в интернете к текущему местоположению пользователя, и, как результат, осуществлять поиск информации среди людей вокруг. Это позволяет искать информацию здесь и сейчас с целью мгновенной встречи с ее владельцем. Ненужное промежуточное звено (поиск по интернету, договор о встрече, дорогу к месту) можно исключить, если потенциально интересующий нас человек (товар, услуга) находится поблизости.',
